          ...
          items: [
            {
              ...
              collapsed: true,
              items: [
                { text: "Client Meeting 1", link: "/sprints/sprint-0/client-meeting-1" },
                { text: "Mentor Meeting 1", link: "/sprints/sprint-0/mentor-meeting-1" },
                { text: "Retrospective", link: "/sprints/sprint-0/retrospective" },
                { text: "Team Meeting 1", link: "/sprints/sprint-0/team-meeting-1" },
              ],
            },
            {
              text: "Sprint 1",
              collapsed: true,
              items: [
                { text: "Client Meeting 1", link: "/sprints/sprint-1/client-meeting-1" },
                { text: "Mentor Meeting 1", link: "/sprints/sprint-1/mentor-meeting-1" },
              ],
            },
            {
              text: "Sprint 2",
              collapsed: true,
              items: [
                { text: "Client Meeting 1", link: "/sprints/sprint-2/client-meeting-1" },
                { text: "Mentor Meeting 1", link: "/sprints/sprint-2/mentor-meeting-1" },
                { text: "Team Meeting 1", link: "/sprints/sprint-2/team-meeting-1" },
              ],
            },
          ],
        },
